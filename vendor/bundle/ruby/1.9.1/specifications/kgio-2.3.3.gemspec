...
applications.}
  ...
  s.test_files = ["test/test_poll.rb", "test/test_peek.rb", "test/test_default_wait.rb", "test/test_no_dns_on_tcp_connect.rb", "test/test_unix_connect.rb", "test/test_pipe_read_write.rb", "test/test_unix_server.rb", "test/test_socketpair_read_write.rb", "test/test_tcp_server.rb", "test/test_unix_server_read_client_write.rb", "test/test_tcp_connect.rb", "test/test_autopush.rb", "test/test_connect_fd_leak.rb", "test/test_singleton_read_write.rb", "test/test_kgio_addr.rb", "test/test_tcp6_client_read_server_write.rb", "test/test_tcp_server_read_client_write.rb", "test/test_unix_client_read_server_write.rb", "test/test_tcp_client_read_server_write.rb", "test/test_pipe_popen.rb", "test/test_accept_class.rb"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_development_dependency(%q<wrongdoc>, ["~> 1.4"])
      s.add_development_dependency(%q<strace_me>, ["~> 1.0"])
    else
      s.add_dependency(%q<wrongdoc>, ["~> 1.4"])
